...
// Catálogo Completo
// ============================================================
// [PEDAGÓGICO] Esta página muestra el catálogo completo de
// productos, con filtros por categoría, búsqueda por texto y
// paginación. Antes vivía dentro de index.php junto con los
// destacados; se separó para que "Mi Tienda UCT" (home) y
// "Catálogo" sean dos páginas distintas con propósitos distintos.
// ============================================================
...
<section class="catalogo-productos">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <?php if (!empty($_GET)): ?>
            <a href="catalogo.php" class="btn btn-outline-secondary btn-sm">✕ Limpiar filtros</a>
        <?php endif; ?>
    </div>
