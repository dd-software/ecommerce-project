...
// ============================================================
// 7. Incluir header (SOLO UNA VEZ - DESPUÉS DE TODA LA LÓGICA)
// ============================================================
require_once __DIR__ . '/includes/header.php';
?>

<!-- ============================================================
     CONTENIDO PRINCIPAL - SIN DUPLICAR HTML
     ============================================================ -->
                ...
                <div class="card-body">
                    ...
                    <form id="form-checkout" method="POST" action="api/checkout.php" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="calle" name="calle" class="form-control" placeholder="Av. Ejemplo 1234, Depto. 5" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="ciudad" name="ciudad" class="form-control" placeholder="Ej: Temuco" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="codigo_postal" name="codigo_postal" class="form-control" placeholder="Ej: 4780000" pattern="[0-9]{7}" title="El código postal chileno tiene 7 dígitos">
                        </div>

                        <div class="mb-3">
                            <label for="notas" class="form-label fw-semibold">📝 Notas (opcional)</label>
                            <textarea id="notas" name="notas" class="form-control" rows="2" placeholder="Indica cualquier instrucción especial para el envío..."></textarea>
                        </div>
                        ...
                        <button type="submit" id="btn-confirmar-transferencia" class="btn btn-success btn-lg w-100 mt-3" style="display:none;">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center resumen-item">
                        <div class="me-3">
                            <?php if (!empty($item['imagen_url'])): ?>
                                <img src="<?= escapar($item['imagen_url']) ?>" alt="<?= escapar($item['alt_text'] ?? $item['nombre']) ?>" class="rounded producto-imagen-mini">
                            <?php else: ?>
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="text-muted"><?= (int) $item['cantidad'] ?> x <?= formato_precio($item['precio_unitario']) ?></small>
                        </div>
                        <div class="fw-semibold"><?= formato_precio($item['precio_unitario'] * $item['cantidad']) ?></div>
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fs-5 fw-bold text-success"><?= formato_precio($totales['total']) ?></span>
                        </div>
                    </div>

                    <div class="mt-4 p-3 bg-light rounded">
                        <small class="text-muted d-block"><i class="fas fa-user"></i> <strong>Cliente:</strong> <?= escapar($_SESSION['usuario_nombre'] ?? '') ?></small>
                        <small class="text-muted d-block"><i class="fas fa-envelope"></i> <strong>Email:</strong> <?= escapar($_SESSION['usuario_email'] ?? '') ?></small>
                    </div>
                </div>
            </div>
        </div>
...
<!-- ============================================================
     SCRIPTS (PayPal SDK y JavaScript)
     ============================================================ -->
<script src="https://www.paypal.com/sdk/js?client-id=<?= PAYPAL_CLIENT_ID ?>&currency=<?= PAYPAL_CURRENCY ?>&intent=capture" data-namespace="paypal_sdk" defer></script>
...
<!-- ============================================================
     ESTILOS ADICIONALES (inline para no crear archivo extra)
     ============================================================ -->
<style>
...
<!-- ============================================================
     OVERLAY DE CARGA (para mostrar mientras se procesa)
     ============================================================ -->
